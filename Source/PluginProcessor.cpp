...
void ThunderforgeAudioProcessor::loadPresetsFromJSON()
{
    ...
    if (presets.empty())
    {
        ...
        presets.push_back ({ "HIGHWAY", 6.5f, 6.0f, 7.0f, 6.0f, 5.0f, -4.0f });
        presets.push_back ({ "THUNDER", 8.5f, 8.0f, 6.0f, 8.0f, 7.0f, -2.0f });
        presets.push_back ({ "HELLS BELLS", 4.5f, 5.0f, 8.0f, 3.0f, 2.0f, -1.0f });
        presets.push_back ({ "SHOOK ME", 6.0f, 4.0f, 7.5f, 7.0f, 6.0f, -3.0f });
        savePresetsToJSON();
    }
}
...
void ThunderforgeAudioProcessor::savePresetsToJSON()
{
    ...
    juce::String jsonString = juce::JSON::toString (array);
